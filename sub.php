				...
				<div class="row">
			        ...
			        <label class="radio">
			  		...
			  		<pre class="well" style="min-height:1px; line-height:15px; border-style:solid; border-width:5px; height:250px;">
						...
						<a href="list.php" onclick="Submit()" class="btn btn-danger pull-right">Submit</a>
						<!--<input type="button" value="Submit" onclick="location.href='http://140.109.22.187/ADAST_rule_engine/subscribe.php?topic=vrtestbed.iis.sinica.edu.tw:3000/data/debris_alerts.xml&alert_type=debris_alert&rule_name=rule.srl"> -->
...
<?php
	// NOTE: Add Submit button to perform the submisson
	//function Submit($topic, $alert_type, $rule_name)
	
		$URLtoGet = "http://140.109.22.187/ADAST_rule_engine/subscribe.php?topic=http://vrtestbed.iis.sinica.edu.tw:3000/data/debris_alerts.xml&alert_type=debris_alert&rule_name=rule.srl";
